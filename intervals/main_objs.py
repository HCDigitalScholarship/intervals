...
class ImportedPiece:
    ...
    def classifyCadences(self, return_type='cadences', keep_keys=False):
        ...
        cadences = pd.read_csv(cwd+'/intervals/data/cadences/CVFLabels.csv', index_col='Ngram')
        ...
        cadDict = pd.read_csv(cwd+'/intervals/data/cadences/cadenceLabels.csv', index_col=0)
